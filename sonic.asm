...
Pal_Sonicblue:	bincludePalette	"palette/Sonic (blue).bin"
Pal_Sonicred:	bincludePalette	"palette/Sonic (red).bin"
Pal_Sonicgreen:	bincludePalette	"palette/Sonic (green).bin"
Pal_Sonicpiss:	bincludePalette	"palette/Sonic (piss).bin"
Pal_Sonictoothpaste:	bincludePalette	"palette/Sonic (toothpaste).bin"
Pal_Sonicpink:	bincludePalette	"palette/Sonic (pink).bin"
Pal_Sonicblack:	bincludePalette	"palette/Sonic (black).bin"
Pal_Sonicwhite:	bincludePalette	"palette/Sonic (white).bin"
palcycle_sonic_rainbowmized:
	dc.w	$822,$a44,$c66,$e88 ; blue
	dc.w	$642,$864,$a86,$ca8 ; blue to green 1
	dc.w	$462,$684,$8a6,$ac8 ; blue to green 2
	dc.w	$282,$4a4,$6c6,$8e8	; green
	dc.w	$284,$4a6,$6c8,$8ea	; green to yellow 1
	dc.w	$286,$4a8,$6ca,$8ec	; green to yellow 2
	dc.w	$288,$4aa,$6cc,$8ee	; yellow
	dc.w	$268,$48a,$6ac,$8ce	; yellow to red 1
	dc.w	$248,$46a,$68c,$8ae	; yellow to red 2
	dc.w	$228,$44a,$66c,$88e	; red
	dc.w	$426,$648,$86a,$a8c ; red to blue 1
	dc.w	$624,$846,$a68,$c8a ; red to blue 2
palcycle_sonic_rainbowmized_end:
...
GM_Title:
		...
		moveq	#palid_Sonicblue,d0	; load Sonic's palette
		bsr.w	PalLoad_Fade
...
.loop:
		...
		cmp.w	d1,d0
		bhi.s	.loop
		lea	titlelevelzone(pc),a0
		add.w	d0,d0
		cmpi.w	#(titlelevelzone_end-titlelevelzone)-2,d0
		bhi.s	.loop
		move.w	(a0,d0.w),(v_zone).w	; set level to GHZ (00)
